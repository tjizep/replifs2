...
/*
 * persist B+ Tree Template Classes s.9.0
...
#ifndef _P_BTREE_MAP_H_
#define _P_BTREE_MAP_H_
#ifdef _MSC_VER
 ...
 */
    ...
    public:
        ...
        void enable_verification(){
            tree.set_verification(true);
        }
        /// enable verification
        void disable_verification(){
            tree.set_verification(false);
        }
    };

} // namespace persist

#endif // _P_BTREE_MAP_H_
