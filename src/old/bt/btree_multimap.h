 ...
 */
    ...
    public:
        ...
        typedef persist::btree<key_type, data_type, storage_type, value_type, key_compare, key_interpolator, traits, true, allocator_type> btree_impl;
    ...
    public:
        ...
        inline btree_multimap
                (InputIterator first, InputIterator upper, const allocator_type &alloc = allocator_type()
                )
        ...
        template<class InputIterator>
        inline btree_multimap
                (InputIterator first, InputIterator upper, const key_compare &kcf,
